...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # When the pattern before it is absent
  end
  ...
  #
  # Why?
  # As they are inclusive in nature
  ...
  def test_variables_can_also_be_used_to_access_captures
    #What is meaning og $1, $2?
    #Originally from Perl, $ are global variables, for which there is a detailed list available(see source)
    #In this case: $1, $2, ...  The match for the first, second, etc. parenthesized groups in the last regular expression.
    #Source: http://ruby.wikia.com/wiki/Special_variable
  ...
  # Character class needs to include all.
  ...
  def test_sub_is_like_find_and_replace
    #the sub-method will substitute the pattern with the expression contained in the block
    #/(t\w*)/ will return the first matching occurence in the string, namely "two"
    #This extracted match will now be handled by the block where $1 will be replaced by the match
    #This will lok like: "two"[0,1] which returns "t", and accordingly the replacement.
    #Source: http://stackoverflow.com/questions/4626425/ruby-regex-question-wrt-the-sub-method-on-string/4626498#4626498
