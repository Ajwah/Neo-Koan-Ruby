...
class AboutJavaInterop < Neo::Koan
  ...
  def test_jruby_provides_question_mark_versions_of_boolean_methods
    ...
    assert_equal 7, java_string.ends_with("String")
  ...
  def test_some_ruby_objects_can_be_coerced_to_java
    assert_equal true, "ruby string".to_java.class
    assert_equal Integer, 1.to_java.class
    assert_equal Float, 9.32.to_java.class
    assert_equal Boolean, false.to_java.class
  end
