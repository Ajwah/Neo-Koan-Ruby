...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # reduces or folds elements of array to a singular result as defined by its body of operations
  end
  ...
  #   # code to read 'file'
  #
  # My guess is that in principle both are viable options, except that the block
  # construct has the additional advantage of closing the io upon termination of
  # the block.
  #
